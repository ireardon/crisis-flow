...
module.exports.ClientDirectory = function ClientDirectory() {
	...
	this.addToChannels = function(client, channels) {
		this.rooms[room].addToChannels(client, channels);
	};
	
	this.removeFromChannels = function(client, channels) {
...
module.exports.ClientDirectoryException = function ClientDirectoryException(message) {	
