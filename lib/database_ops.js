...
var conn = anyDB.createConnection(config.DATA_ANYDB_CONNECT_ID);
var sessionConn = anyDB.createConnection(config.SESSION_ANYDB_CONNECT_ID);
...
function createRoom(roomName) {
	...
	var sql = 'INSERT INTO rooms(name) VALUES($1);';
